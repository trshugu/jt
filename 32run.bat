@echo off
"C:\Program Files (x86)\Java\jdk1.8.0_66\bin\javac" -encoding utf-8 tmp.java -classpath ./jar\*;./ -Xlint:unchecked
"C:\Program Files (x86)\Java\jdk1.8.0_66\bin\java" -classpath ./jar\*;./ tmp
